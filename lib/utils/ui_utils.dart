...
import '../screens/base main/distributor/payments_screen.dart';
import '../screens/distributer_pages/allocations/allocations_screen.dart';
import '../screens/distributer_pages/customer/customer_screen.dart';
import '../screens/distributer_pages/products/product_screen.dart';
...
class UiUtils {
  ...
  Widget VendormenuItem(BuildContext context, String title, IconData icon, {Widget? trailing}) {
    return GestureDetector(
      onTap: () {
        // Handle navigation here
