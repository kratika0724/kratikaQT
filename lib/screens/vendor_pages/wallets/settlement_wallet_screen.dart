...
class SettlementWalletScreen extends StatefulWidget {
  ...
  @override
  State<SettlementWalletScreen> createState() => SettlementWalletScreenState();
}

class SettlementWalletScreenState extends State<SettlementWalletScreen> {
  // Static sample data
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: HeaderTextBlack("Settlement Wallet"),
      ),
      body: Column(
        children: [
          // Wallet Balance Card
