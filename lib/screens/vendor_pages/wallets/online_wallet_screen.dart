...
class OnlineWalletScreen extends StatefulWidget {
  const OnlineWalletScreen({super.key});

  @override
  State<OnlineWalletScreen> createState() => OnlineWalletScreenState();
}

class OnlineWalletScreenState extends State<OnlineWalletScreen> {
  // Static sample data
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: HeaderTextBlack("Online Wallet"),
      ),
      body: Column(
        children: [
          // Wallet Balance Card
