...
import '../../../models/sample models/settlement_model.dart'; // Assuming your models are in this path

class SettlementCard extends StatelessWidget {
  final SettlementModel payment;
  ...
  Widget _buildBaseInfoRow(String refId,String status,
    ...
    return Row(
      children: [
        ...
        //   ),
        // ),
        Icon(isExpanded ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down, color: Colors.black, size: 22),
      ],
    );
  }
