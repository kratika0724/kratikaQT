        ...
        child: Column(
          ...
          children: [
            _buildAmountAndStatus(
                ...
                formattedDate,
                transaction.status,
                transaction.walletHistory.transactionType,
                bgColorStatus,
                statusColor,
            ...
            const Padding(
              ...
              child: DottedLine(
                  dashLength: 4.0, dashColor: Colors.grey, lineThickness: 1),
            ),
            Row(
              children: [
                Expanded(
                  child: _buildBaseInfoRow(transaction.user.firstName +
                      " " +
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow(
                        "Quintus ID", "${transaction.quintusTransactionId}"),
                  ],
                ),
              ),
          ],
            ...
            children: [
              Text(
                ...
                style: semiBoldTextStyle(
                    fontSize: dimen16, color: textColorStatus),
              ),
              Text(
                createdAt,
                overflow: TextOverflow.ellipsis,
