...
//     final isHeight = DeviceUtils.getDeviceHeight(context);
...
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:qt_distributer/utils/device_utils.dart';
import '../../../constants/app_colors.dart';
import '../../../constants/app_textstyles.dart';
import '../../providers/dashboard_provider.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const Center(
                          child: Icon(Icons.person, size: 40, color: Colors.black), // Reduced size to prevent overflow
                        ),
                      ),
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: mediumTextStyle(fontSize: dimen15, color: Colors.black54),
                      ),
                    ),
                  ],
                ),
